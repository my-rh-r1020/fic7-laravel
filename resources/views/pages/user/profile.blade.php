                        ...
                        <form method="post" action="{{ route('user-password.update') }}" class="needs-validation" novalidate="">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="current_password" class="form-control @error('current_password','updatePassword') is-invalid @enderror" placeholder="Password" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" class="form-control @error('password','updatePassword') is-invalid @enderror" placeholder="Password" required>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <input type="text" name="phoneNumber" class="form-control @error('phoneNumber','updateProfileInformation') is-invalid @enderror" value="{{ auth()->user()->phoneNumber }}" required>
                                        @error('phoneNumber','updateProfileInformation')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                        @enderror
